...
**** Get NodeJS - Install it at https://nodejs.org/dist/v12.18.0/node-v12.18.0-x64.msi ****
When installing node: make sure you check where it says
...
Once nodejs has been installed, verify by opening a command prompt as administrator. 

Type "node -v" with no quotes. It should be v12. something. Now do "npm i pm2 -g" and wait for that to finish.
